...
write.xlsx(tab_final,"tabela_preco_segmento2_150_400_0.xlsx",sheetName="Sheet1",col.names=TRUE, row.names=FALSE)
...
setwd("~/Price_Elast/Segmento_2_125K/F7_BASE/z.tabelas")
library(readxl)
tab_final <- read_excel("tabela_preco_segmento2_150_400_0.xlsx")
...
dat_dif<-tab_prec[tab_prec$prec_tab>tab_prec$minimo&tab_prec$qtd_original>0,]
...
setwd("~/Price_Elast/Segmento_2_125K/F7_BASE/y.output")
write.xlsx(datf,"tabela_resultados_CL1_segmento2_150_400_0.xlsx",sheetName="Sheet1",col.names=TRUE, row.names=FALSE)
